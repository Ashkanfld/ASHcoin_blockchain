...
# creating an address the node on port 500
...
def mine_block(): 
    ...
    blockchain.add_transaction(sender = node_address,receiver = 'Ashkan', amount =1)
...
def is_valid():
    ...
    if is_valid:
        response = 'Congrats The blockchain is totaly valid'
    else:
...
def connect_node():
    ...
    response = {'message':'All the nodes are now connected. The Ashcoin blockchain now contains following nodes'
